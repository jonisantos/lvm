...
public class LojaVirtualMentoriaApplicationTests extends TestCase {
	...
	public void testRestApiCadastroAcesso() throws JsonProcessingException, Exception {
		...
		Acesso objetoReorno = objectMapper.readValue(retornoApi.andReturn().getResponse().getContentAsString(),
				Acesso.class);

		assertEquals(acesso.getDescricao(), objetoReorno.getDescricao());
